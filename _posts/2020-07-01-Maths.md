...
Trong chương này, chúng tôi giới thiệu các tác nhân[[actor<br/>::lsn]] chính của đại số tuyến tính và phép tính đa biến.





**Definition 1.1 (Point, vector, and coordinates).** Phần tử của $$\mathbb{R}^{n}$$ với tọa độ $$x_1 , x_2 , \cdots , x_n$$ có thể được hiểu là một điểm
$$\mathbf{x} = \left(
\begin{matrix}
x_1 \\ \vdots \\ x_n
\end{matrix}
