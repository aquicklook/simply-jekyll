...
**Definition 1.1.2 (Point, vector, and coordinates).** Trong không gian $$\mathbb{R}^{n}$$ các phần tử có tọa độ $$x_1 , x_2 , \cdots , x_n$$ có thể được gọi là điểm $$x = \begin{pmatrix}x_1
\\ \vdots 
\\ x_n
\end{pmatrix}$$
