...
<span class="label label-info"> User Interface</span>
        ...
        <nav>
            ...
            <ul><li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none;">3.1. Analysis</a></li>
                ...
                <li class="re-li makedl a"><a href="#chu-thich" style="background-image: none;">3.4. Research connects vaping to a higher chance of catching the virus — and suffering its worst effects.</a></li></ul></li>
