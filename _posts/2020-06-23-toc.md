...
<span class="label label-info"> User Interface</span>
        ...
        <nav>
            <ul class="toc-list">
                <li class="re-li"><a class="makedl a" href="#the_basics" style="background-image: none; font-weight: 600;">1. The basics</a></li>
                <li class="re-li"><a class="makedl a" href="#skill-stackers" style="background-image: none; font-weight: 600;">2. Skill stackers in action</a></li>
                <li class="re-li"><a class="makedl a" href="#special-skill" style="background-image: none; font-weight: 600;">3. What is your special skill stack?</a>
            <ul><li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none;">3.1. Analysis</a></li>
                <li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none;">3.2. Reference</a></li>
                <li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none;">3.3. Reference</a></li>
                <li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none;">3.4. Research connects vaping to a higher chance of catching the virus — and suffering its worst effects.</a></li></ul></li>
                <li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none; font-weight: 600;">4. Reference</a></li>
                <li class="re-li"><a class="makedl a" href="#chu-thich" style="background-image: none; font-weight: 600;">5. Reference</a></li>
            </ul>
        </nav>
</div>
