...
<button type="button" class="close" data-dismiss="modal" aria-label="Close" style="border-width: 1px;width: 18px;height: 28px;border-radius: 2px;outline: none;background: transparent;"><span aria-hidden="true">×</span></button>
