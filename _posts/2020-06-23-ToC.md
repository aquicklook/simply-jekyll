...
<div id="toc-container">    
        <nav>
            <ul class="toc-list">
                <li class="re-li"><a href="#the_basics" style="background-image: none;">The basics</a></li>
                <li class="re-li"><a href="#skill-stackers" style="background-image: none;">Skill stackers in action</a></li>
                <li class="re-li"><a href="#special-skill" style="background-image: none;">What is your special skill stack?</a>
            <ul><li class="re-li"><a href="#" style="background-image: none;">Analysis</a></li></ul></li>
