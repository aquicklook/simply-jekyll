...
<div id="toc_container"><div class="toc_title">Table of Contents: <a onclick="toggle_visibility('toc');">
<div style="min-width: 24px; min-height: 24px;">
<button class="Show" style="padding: 0; border-width: 0px; outline: none; border-style: solid; cursor: pointer;">Show</button>
<button class="Hide" style="padding: 0; border-width: 0px; outline: none; border-style: solid; cursor: pointer;">Hide</button></a>
<div id="toc">
