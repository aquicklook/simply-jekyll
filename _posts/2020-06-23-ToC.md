...
<div id="toc-container">    
        <nav>
            <ul class="toc-list">
                <li class="re-li"><a href="#the_basics" style="background-image: none;">**1. The basics**</a></li>
                <li class="re-li"><a href="#skill-stackers" style="background-image: none;">2. Skill stackers in action</a></li>
                <li class="re-li"><a href="#special-skill" style="background-image: none;">3. What is your special skill stack?</a>
            <ul><li class="re-li"><a href="#" style="background-image: none;">3.1. Analysis</a></li></ul></li>
