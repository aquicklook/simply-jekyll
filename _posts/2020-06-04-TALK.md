...
<script type="text/javascript" style="background-image: none;">
    var gitalk = new Gitalk({
		...
		owner: 'aquicklook',
		admin: ['aquicklook'],
  Id: location. pathname, // to mark which page the comment is, make sure it's unique and less than 50 in length
   });
