...
<div class="video-wrapper" style="margin-top: 28.080px;">
    <iframe src="https://www.youtube.com/embed/U5kIdtMJGc8?fs=0" height="382.5" width="680" style="box-shadow: 0 1px 4px rgba(0,0,0,.04), inset 0 0 0 1px rgba(0,0,0,.09);" allowfullscreen="" frameborder="0">
    </iframe>
</div>
Jim Simons was a mathematician and cryptographer who realized: the complex math he used to break codes could help explain patterns in the world of finance. Billions later, he’s working to support the next generation of math teachers and scholars. TED’s Chris Anderson sits down with Simons to talk about his extraordinary life in numbers.

<div class="video-wrapper" style="margin-top: 28.080px;">
    <iframe id="ytplayer" type="text/html" width="680" height="382.5" style="box-shadow: 0 1px 4px rgba(0,0,0,.04), inset 0 0 0 1px rgba(0,0,0,.09);" src="https://www.youtube.com/embed/bAyrObl7TYE" frameborder="0" allowfullscreen>
    </iframe>
</div>
...
<div class="makeup-container">
  <div class="container-content-timeline">
    <div class="makeup a"><a href="https://quicklook.netlify.app/notes/how-to-read-and-write-mathematics" oncontextmenu="displayEmbedCode(this);return false;"  >How to Read and Write Mathematics?</a></div>
...
<div class="makeup img"><img src="https://images.unsplash.com/photo-1578667343354-26a1de5bfe5a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1650&q=80"  alt="How to Read and Write Mathematics?"></div>
</div>
