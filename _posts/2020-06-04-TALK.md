...
<center style="margin-top: 28.080px; max-width: 680px; min-width: auto; heigt: 500px; display: block; overflow-y: scroll; overflow-x: hidden; "><script>
  window.fbAsyncInit = function() {
    FB.init({
      xfbml      : true,
      version    : 'v8.0'
...
<div 
  ...
  data-width="548px" data-height="500px"></div></center>
