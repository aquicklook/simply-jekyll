...
<div class="video-wrapper" style="margin-top: 28.080px;">
    <iframe id="ytplayer" type="text/html" width="680" height="382.5" src="https://www.youtube.com/embed/M7lc1UVf-VE" frameborder="0" allowfullscreen>
    </iframe>
</div>
...
<center style="margin-top: 28.080px; max-width: 680px; min-width: auto; display: block;"><iframe name = "Framename" src = " https://www.wsj.com/ " width = "680" height = "500" frameborder = "0" scrolling = "yes" style = "width: 100%; border-radius: 4px; border:1px solid rgba(0,0,0,.54); border-width:1px;"> </iframe></center>

<center style="margin-top: 28.080px; max-width: 680px; min-width: auto; display: block;"><iframe src = " https://quicklook.netlify.app/posts/talk "> </iframe></center>
