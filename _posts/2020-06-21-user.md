...
<span class="label label-info"> User Interface</span>
        ...
        <nav>
            <ul class="toc-list">
                ...
                <li class="re-li makedl a" style="padding: 5px 0px;"><a href="#special-skill" style="background-image: none; line-height: normal !important;">What is your special skill stack?</a>
            <ul style="border-left: 3px solid #292929; padding: 5px 0px;">
		    <li class="re-li makedl a" style="padding: 5px 0px;"><a href="#skill" style="background-image: none; line-height: normal !important;">Why Stories Captivate</a></li>
		    <li class="re-li makedl a" style="padding: 5px 0px;"><a href="#best" style="background-image: none; line-height: normal !important;">You’re the best in the world</a></li></ul></li>
