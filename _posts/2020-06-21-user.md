...
<button type="button" class="close av dj ax ay az ba bb bc bd bf dk dl bl dm dn" onclick="cmtContainer()" data-dismiss="modal" aria-label="close"><span aria-hidden="true"><svg width="25" height="25" viewBox="0 0 25 25" class="aw"><path d="M18.13 6.11l-5.61 5.61-5.6-5.61-.81.8 5.61 5.61-5.61 5.61.8.8 5.61-5.6 5.61 5.6.8-.8-5.6-5.6 5.6-5.62"></path></svg></span></button>
