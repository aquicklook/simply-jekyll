...
<button type="button" class="close boo ch ax ay az ba bb bcc bdd be dl dm bh dn do" onclick="tocContainer()" data-dismiss="modal" aria-label="Close"><svg width="25" height="25" viewBox="0 0 25 25"><path d="M18.13 6.11l-5.61 5.61-5.6-5.61-.81.8 5.61 5.61-5.61 5.61.8.8 5.61-5.6 5.61 5.6.8-.8-5.6-5.6 5.6-5.62" fill-rule="evenodd"></path></svg></button>
        ...
        <nav>
		<ul class="toc-list">
                <li class="re-li makedl a" style="padding: 8px 0px;"><a href="#the_basics" style="background-image: none; line-height: normal !important;">The basics</a></li>
                <li class="re-li makedl a" style="padding: 8px 0px;"><a href="#skill-stackers" style="background-image: none; line-height: normal !important;">Skill stackers in action</a></li>
                <li class="re-li makedl a" style=""><a href="#special-skill" style="background-image: none;line-height: normal !important;padding: 8px 0px;">What is your special skill stack?</a>
            <ul style="border-left: 3px solid #292929;">
		    <li class="re-li makedl a" style="padding: 8px 10px;"><a href="#skill" style="background-image: none; line-height: normal !important;">Why Stories Captivate</a></li>
		    <li class="re-li makedl a" style="padding: 8px 10px;"><a href="#best" style="background-image: none; line-height: normal !important;">You’re the best in the world</a></li></ul></li>
                <li class="re-li makedl a" style="padding: 8px 0px;"><a href="#index" style="background-image: none; line-height: normal !important;">Index</a></li>
                <li class="re-li makedl a" style="padding: 8px 0px;"><a href="#chu-thich" style="background-image: none; line-height: normal !important;">Responses</a></li>
            </ul>
        </nav>
</div>
