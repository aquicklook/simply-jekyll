...
<span class="label label-info"> User Interface</span>
        ...
        <nav>
            <ul class="toc-list">
                <li class="re-li makedl a" style="padding: 5px 10px;"><a href="#the_basics" style="background-image: none; line-height: normal !important;">The basics</a></li>
                <li class="re-li makedl a" style="padding: 5px 10px;"><a href="#skill-stackers" style="background-image: none; line-height: normal !important;">Skill stackers in action</a></li>
                <li class="re-li makedl a" style="padding: 5px 10px;"><a href="#special-skill" style="background-image: none; line-height: normal !important;">What is your special skill stack?</a>
		    ...
		    <li class="re-li makedl a" style="padding: 5px 10px;"><a href="#best" style="background-image: none; line-height: normal !important;">You’re the best in the world</a></li></ul></li>
                <li class="re-li makedl a" style="padding: 5px 10px;"><a href="#index" style="background-image: none; line-height: normal !important;">Index</a></li>
                <li class="re-li makedl a" style="padding: 5px 10px;"><a href="#chu-thich" style="background-image: none; line-height: normal !important;">Responses</a></li>
            </ul>
        </nav>
</div>
