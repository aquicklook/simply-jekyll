...
<center style="margin-top: 28.080px; max-width: 680px; min-width: auto; display: block;"><iframe src="https://docs.google.com/presentation/d/e/2PACX-1vRySya5rpoLy9d0j-3JyquSWgqliUC07WQeSbZ-eobvZ7GkpgveqCSOUkLKvUMzaNgGk7mx7Eb9U979/embed?start=false&loop=false&delayms=3000" frameborder="0" width="100%" height="411" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" marginwidth="0" marginheight="0" scrolling="no" style="box-shadow: 0 1px 4px rgba(0,0,0,.04), inset 0 0 0 1px rgba(0,0,0,.09); max-width: 100%;"></iframe></center>
