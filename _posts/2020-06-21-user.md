...
<div class="user-guide-header">
<button type="button" class="close" onclick="tocContainer()" data-dismiss="modal" aria-label="Close" style="border-width: 0px;outline: none;background: transparent;margin: 0;padding: 0;"><span aria-hidden="true"><amp-icon class="icon hydrated" role="presentation" aria-hidden="true" innerhtml="<svg width="25" height="25" viewBox="0 0 25 25" class="aw"><path d="M18.13 6.11l-5.61 5.61-5.6-5.61-.81.8 5.61 5.61-5.61 5.61.8.8 5.61-5.6 5.61 5.6.8-.8-5.6-5.6 5.6-5.62"></path></svg></span></button>
</div>
