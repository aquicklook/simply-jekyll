document.addEventListener('DOMContentLoaded', () => { 
  ...
  const previewThumbnails = { enabled: true , src: ['https://cdn.plyr.io/static/demo/thumbs/100p.vtt'] }
  ...
  const player = new Plyr('#player', { debug: true , title: 'Quicklook Play Video' , iconUrl: 'https://cdn.jsdelivr.net/gh/theprojectsomething/plyr@a55bf00/demo/dist/demo.svg' , controls , settings , i18n , speed , keyboard , tooltips , captions , previewThumbnails , vimeo , fullscreen });
