...
— Một số mệnh đề thường được phát biểu dưới dạng lượng từ phổ biến $$\forall$$ hoặc lượng từ tồn tại $$\exists$$. Ví dụ "Mọi phần tử $$x$$ của tập hợp $$X$$ đều có tính chất $$\wp(x)$$".
