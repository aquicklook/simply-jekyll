...
Mục đích chính của việc học ngôn ngữ toán học là để giao tiếp ý tưởng, nghĩa là nó có tính hai chiều. Hiểu ý nghĩa của các ký hiệu và cách đọc viết thôi chưa đủ bởi vì điều này mới chỉ giải quyết được một phần của vấn đề đó là hiểu được ý tưởng của các nhà toán học khác. Để có thể giao tiếp ngược lại với họ, bạn cần trang bị cho bản thân một số kiến thức của [Abstract algebra](http://www.math.niu.edu/~beachy/aaol/contents.html)[[Propositional and logical, Sets, Mapping, Algebraic structure, Functions, Integers, Real...::srs]].
