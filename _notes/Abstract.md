...
Cách đọc toán lại hoàn toàn khác, đôi lúc bạn sẽ không hiểu phần trước nếu chưa đọc phần sau, thỉnh thoảng dành nhiều thời gian để nghiền ngẫm câu từ lại không hiệu quả bằng tham khảo qua các ví dụ hoặc hình ảnh và đương nhiên bạn sẽ phải đọc với số chiều nhiều hơn 2. Sau đây là một số hướng dẫn về việc đọc toán mà tôi cho rằng nó rất hữu ích cho mọi người.
