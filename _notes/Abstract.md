...
*Mệnh đề* hay mệnh đề logic là một phát biểu khẳng định có tính chất hoặc đúng hoặc sai, không thể nhập nhằng, nghĩa là không thể vừa đúng vừa sai, cũng không thể vừa không đúng vừa không sai.
