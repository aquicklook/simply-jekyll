...
Mục đích chính của việc học ngôn ngữ toán học là để giao tiếp ý tưởng, nghĩa là nó có tính hai chiều. Hiểu ý nghĩa của các ký hiệu và cách đọc viết thôi chưa đủ bởi vì nó chỉ đang dẫn bạn đến một phần của vấn đề: hiểu được ý tưởng của các nhà toán học khác. Để có thể giao tiếp lại với họ, bạn cần trang bị cho bản thân một số kiến thức của [Abstract Algebra](http://www.math.niu.edu/~beachy/aaol/contents.html) bao gồm: Propositional and logical, Sets, Mapping, Algebraic structure, Functions, Integers number, Real number... đã được đề cập ở phần sau.
