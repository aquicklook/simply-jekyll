...
Thật may, giống như hầu hết việc học các ngôn ngữ khác, ngôn ngữ toán học cũng có một số các ký hiệu và các quy tắc được sử dụng đều đặn, như các chủ đề về tập hợp, logic, ánh xạ... Mục tiêu của phần này là giới thiệu một số khái niệm cơ bản và phương pháp đọc toán để mọi người đọc tốt toán và hứng thú hơn trong việc tìm hiểu các phần còn lại. Mặc dù vậy, tương tự như việc học tiếng anh, bên cạnh việc củng cố ngữ pháp thì thường xuyên trau dồi vốn từ vựng là điều thực sự cần thiết. Toán học cũng vậy, sẽ không có một công thức chung để học nó hiệu quả nếu như bạn lười biếng tìm hiểu.   
