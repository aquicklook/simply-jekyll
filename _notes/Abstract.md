...
— Mệnh đề được phát biểu bằng văn xuôi và được quy ước bằng các ký hiệu toán học. Thông thường, ta hay gặp mệnh đề được phát biểu dưới dạng lượng từ phổ biến $$\forall$$ và lượng từ tồn tại $$\exists$$. Ví dụ "Mọi phần tử $$x$$ của tập hợp $$X$$ đều có tính chất $$\mathcal{P}(x)$$" được viết gọn là $$\forall x \in X, \mathcal{P}(x)$$
