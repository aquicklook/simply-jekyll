...
<br>
Phủ định của mệnh đề có dạng lượng từ phổ biến là tồn tại hoặc tồn tại duy nhất một phần tử $$x$$ của $$X$$ không có tính chất $$\mathcal{P}(x)$$, ta viết gọn là

$$\overline{\forall x \in X, \mathcal{P}(x)} \equiv \exists! x \in X, \overline{\mathcal{P}(x)}$$
