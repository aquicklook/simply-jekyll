...
Có một câu chuyện được kể đằng sau mỗi khái niệm toán học. Vì vậy với mỗi khái niệm mà bạn tìm hiểu, bạn nên hình dung ra một bức tranh tổng thể về nó. Bức tranh này là câu trả lời cho các câu hỏi cơ bản khi tìm hiểu về một vấn đề, bao gồm phân tích về bối cảnh lịch sử và sự phát triển của các ý tưởng đồng thời chỉ ra ưu, nhược điểm của các ý tưởng được trình bày.[[Ý nghĩa của chúng là gì? Nó có những giả thuyết nào? Nó có những hàm ý gì? Có những trường hợp đặc biệt nào bạn cần lưu ý không? Đưa ra các ví dụ áp dụng vào thực tế và các ví dụ không thỏa mãn các giả thuyết và kết luận của chúng.::rsn]] Để làm được như vậy, bạn cần phải đọc đi đọc lại nội dung nhiều lần, thậm chí tham khảo ở bên ngoài.
